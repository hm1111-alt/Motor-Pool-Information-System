                    ...
                    <form method="POST" action="{{ route('vehicles.update', $vehicle) }}" enctype="multipart/form-data">
                        ...
                        <div class="grid grid-cols-1 gap-6">
                            ...
                            <div>
                                ...
                                <div class="mt-1 flex items-center">
                                    <div class="h-32 w-32 bg-gray-200 rounded-md flex items-center justify-center overflow-hidden">
                                        @if($vehicle->picture)
                                            <img id="preview-image" src="{{ asset('storage/' . $vehicle->picture) }}" alt="Vehicle Image" class="h-full w-full object-cover">
                                            <svg id="placeholder-icon" class="h-12 w-12 text-gray-400 hidden" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                            ...
                            <div>
                                ...
                                <input type="text" name="fuel_type" id="fuel_type" value="{{ old('fuel_type', $vehicle->fuel_type) }}" required
                                    class="mt-1 block w-full border border-gray-300 rounded-md shadow-sm py-2 px-3 focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm">
                            </div>
                            ...
                            <div>
                                ...
                                <input type="number" name="seating_capacity" id="seating_capacity" value="{{ old('seating_capacity', $vehicle->seating_capacity) }}" min="1" required
                                    class="mt-1 block w-full border border-gray-300 rounded-md shadow-sm py-2 px-3 focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm">
                            </div>
                            ...
                            <div>
                                ...
                                <input type="number" name="mileage" id="mileage" value="{{ old('mileage', $vehicle->mileage) }}" min="0" required
                                    class="mt-1 block w-full border border-gray-300 rounded-md shadow-sm py-2 px-3 focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm">
                            </div>
                            ...
                            <div>
                                ...
                                <select name="status" id="status" required
                                    ...
                                    <option value="Not Available" {{ old('status', $vehicle->status) == 'Not Available' ? 'selected' : '' }}>Not Available</option>
