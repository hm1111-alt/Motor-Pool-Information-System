    ...
    <x-slot name="header">
        <div class="flex items-center justify-between">
            <div class="flex items-center">
                <a href="{{ route('admin.leaders.offices') }}" class="mr-4 text-gray-500 hover:text-gray-700">
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="bg-white shadow-sm sm:rounded-lg mb-8">
                <div class="p-6">
                    <div class="flex items-center justify-between mb-6">
                        <div>
                            <h3 class="text-lg font-bold text-gray-900">Vice President</h3>
                            <p class="text-gray-600 mt-1">Office-level leadership</p>
                        </div>
                        @if($vp)
                        ...
                        <div class="flex items-center justify-between">
                            <div class="flex items-center">
                                <div class="flex-shrink-0 h-16 w-16">
                                    <div class="bg-blue-100 border-2 border-blue-200 rounded-xl w-16 h-16 flex items-center justify-center">
                                ...
                                <div class="ml-4">
                                    @if($vp)
                                        <div class="text-xl font-semibold text-gray-900">{{ $vp->first_name }} {{ $vp->last_name }}</div>
                                        <div class="text-gray-600">{{ $vp->position_name }}</div>
                                    ...
                                    @else
                                        <div class="text-xl font-semibold text-gray-400">No Vice President Assigned</div>
                                        <div class="text-gray-500">Office Leadership Role</div>
                            ...
                            <div>
                                ...
                                @if(!$isPresidentOffice)
                                    <a href="{{ route('admin.leaders.edit', ['type' => 'vp', 'id' => $office->id]) }}" 
                                       class="inline-flex items-center px-4 py-2 border border-transparent text-sm font-medium rounded-lg shadow-sm text-white {{ $vp ? 'bg-indigo-600 hover:bg-indigo-700' : 'bg-green-600 hover:bg-green-700' }} focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 transition duration-150">
            ...
            <div class="bg-white shadow-sm sm:rounded-lg">
                <div class="p-6">
                    <div class="flex items-center justify-between mb-6">
                        <div>
                            <h3 class="text-lg font-bold text-gray-900">Divisions</h3>
                            <p class="text-gray-600 mt-1">Division-level leadership under this office</p>
                        </div>
                                    ...
                                    <div class="p-5">
                                        <div class="flex items-center justify-between mb-4">
                                            <div class="flex items-center">
                                                ...
                                                <div class="ml-4">
                                                    <h4 class="text-base font-semibold text-gray-900">{{ $division->division_name }}</h4>
                                            ...
                                            <div class="flex items-center justify-between">
                                                ...
                                                <div class="flex space-x-2">
                                                    <a href="{{ route('admin.leaders.division.show', $division) }}" 
                                                       class="inline-flex items-center px-3 py-1.5 border border-transparent text-xs font-medium rounded-md shadow-sm text-white bg-indigo-600 hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 transition duration-150">
                                                        <svg class="h-3 w-3 mr-1" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                                    ...
                                                    <a href="{{ route('admin.leaders.edit', ['type' => 'division_head', 'id' => $division->id]) }}" 
                                                       class="inline-flex items-center px-3 py-1.5 border border-transparent text-xs font-medium rounded-md shadow-sm text-white {{ $divisionHead ? 'bg-purple-600 hover:bg-purple-700' : 'bg-green-600 hover:bg-green-700' }} focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-purple-500 transition duration-150">
                                                        <svg class="h-3 w-3 mr-1" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M11 5H6a2 2 0 00-2 2v11a2 2 0 002 2h11a2 2 0 002-2v-5m-1.414-9.414a2 2 0 112.828 2.828L11.828 15H9v-2.828l8.586-8.586z" />
                                                        </svg>
