...
@php $rowIndex++; @endphp
    ...
    <td style="padding: 8px 6px; text-align: center;" class="whitespace-nowrap">
        <div class="action-buttons">
            <button type="button" class="btn inline-flex items-center mr-1" style="color: #3b82f6 !important; border: 1px solid #3b82f6 !important; background-color: transparent !important;" onclick="openViewEmployeeModal({{ $employee->id }})">
