<x-app-layout>
                ...
                <div class="p-6 text-gray-900">
                    ...
                    <div class="overflow-x-auto rounded-lg shadow">
                        <table class="min-w-full divide-y divide-gray-200">
                            ...
                            <tbody class="bg-white divide-y divide-gray-200" id="unitsTableBody">
    ...
    <div id="deleteModal" class="fixed inset-0 bg-black bg-opacity-50 hidden items-center justify-center z-50">
        <div class="bg-white rounded-lg shadow-xl max-w-md w-full mx-4">
            <div class="p-6">
                ...
                <p class="text-gray-600 mb-4">Are you sure you want to delete this unit? This action cannot be undone.</p>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            function fetchUnits() {
                const url = new URL('{{ route("admin.units.index") }}', window.location.origin);
                ...
                .then(data => {
                    unitsTableBody.innerHTML = data.table_body;
                    paginationContainer.innerHTML = data.pagination;
                    attachEventListeners();
                })
                .catch(error => {
                    console.error('Error:', error);
                    Swal.fire('Error', 'Failed to load units data', 'error');
                });
            }
