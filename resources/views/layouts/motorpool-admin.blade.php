            ...
            <div x-data="{ sidebarOpen: true }" class="flex">
                ...
                <div :class="sidebarOpen ? 'w-64 md:w-64' : 'w-20'" class="bg-white shadow-lg transition-all duration-300 ease-in-out flex flex-col h-screen sticky top-0 overflow-hidden">
                    ...
                    <nav class="flex-1 px-2 py-4 overflow-y-auto">
                        ...
                        <a href="{{ route('approved-travel-orders.index') }}" class="flex items-center px-4 py-3 text-gray-700 hover:bg-gray-100 rounded-lg transition-colors duration-200 mb-1">
                            <div class="rounded-lg bg-[#1e6031] p-2 mr-3 flex-shrink-0">
                                <svg class="h-5 w-5 text-white" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2" />
                                </svg>
                            </div>
                            <span :class="sidebarOpen ? 'block' : 'hidden'" class="font-medium truncate">Approved Travel Orders</span>
                        </a>
