            ...
            <div class="bg-white overflow-hidden shadow rounded border border-gray-100">
                <div class="p-4">
                    <div class="mb-4 pb-2 border-b border-gray-200">
                        ...
                        <p class="text-gray-600 text-sm mt-1">List of all travel orders approved by the VP.</p>
                    </div>
                        ...
                        <table class="min-w-full divide-y divide-gray-200">
                            <thead class="bg-gray-50">
                                <tr>
                                    ...
                                    <th scope="col" class="px-4 py-2 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Office</th>
                                    ...
                                    <th scope="col" class="px-4 py-2 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">VP Approved</th>
                                </tr>
                            </thead>
                            <tbody class="bg-white divide-y divide-gray-200">
                                @forelse($travelOrders as $travelOrder)
                                    <tr>
                                        ...
                                        <td class="px-4 py-2 whitespace-nowrap text-sm text-gray-900">
                                            {{ $travelOrder->employee->office->name ?? 'N/A' }}
                                        </td>
                                        ...
                                        <td class="px-4 py-2 whitespace-nowrap text-sm text-gray-900">
                                            {{ $travelOrder->vp_approved_at->format('M d, Y g:i A') }}
                                        </td>
                                    </tr>
                                @empty
                                    <tr>
