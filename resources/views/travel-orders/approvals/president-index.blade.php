            ...
            <div class="bg-white overflow-hidden shadow rounded border border-gray-100">
                <div class="p-4">
                    <div class="mb-4 pb-2 border-b border-gray-200">
                        ...
                        <p class="text-gray-600 text-sm mt-1">Review and approve travel requests from VPs.</p>
                    </div>
                    ...
                    <div class="mb-4">
                        <div class="relative rounded-md shadow-sm">
                            ...
                            <input type="text" 
                                   ...
                                   data-url="{{ route('travel-orders.approvals.president') }}"
                                   value="{{ $search ?? '' }}">
                    ...
                    <div class="overflow-x-auto">
                        <table id="approval-table" class="min-w-full divide-y divide-gray-200">
                            ...
                            <tbody class="bg-white divide-y divide-gray-200" id="approval-table-body">
                                @include('travel-orders.approvals.partials.table-rows', ['travelOrders' => $travelOrders, 'tab' => $tab ?? 'pending', 'approvalShowRoute' => 'travel-orders.approval-show.president'])
                            </tbody>
                        </table>
                    </div>
                    <!-- Pagination -->
