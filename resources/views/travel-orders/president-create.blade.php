            ...
            <div class="bg-white overflow-hidden shadow rounded border border-gray-100">
                <div class="p-4">
                    <div class="mb-4 pb-2 border-b border-gray-200">
                        ...
                        <p class="text-sm text-gray-600 mt-1">As President, your travel requests are automatically approved.</p>
                    </div>
                    ...
                    <form method="POST" action="{{ route('president.travel-orders.store') }}">
                        @csrf
                        ...
                        <div class="mt-4 flex items-center justify-end">
                            <a href="{{ route('president.travel-orders.index') }}" class="mr-3 inline-flex items-center px-4 py-2 bg-white border border-gray-300 rounded-md font-semibold text-xs text-gray-700 uppercase tracking-widest shadow-sm hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2 disabled:opacity-25 transition ease-in-out duration-150">
                                Cancel
                            </a>
                            <button type="submit" class="inline-flex items-center px-4 py-2 bg-[#1e6031] border border-transparent rounded-md font-semibold text-xs text-white uppercase tracking-widest hover:bg-[#164f2a] focus:bg-[#164f2a] active:bg-[#1e6031] focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2 transition ease-in-out duration-150">
                                Create Travel Request (Auto-Approved)
                            </button>
                        </div>
                    </form>
                </div>
