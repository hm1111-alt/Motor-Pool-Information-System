...
@section('content')
                    ...
                    <div class="overflow-x-auto">
                        <table id="drivers-table" class="min-w-full divide-y divide-gray-200">
                            ...
                            <tbody class="bg-white divide-y divide-gray-200" id="drivers-table-body">
                                @include('drivers.partials.table-rows', ['drivers' => $drivers])
                            </tbody>
                        </table>
                    </div>

                    <!-- Pagination -->
                    <div id="drivers-pagination-section">
                        @if($drivers->hasPages())
                            <div class="mt-6">
    ...
    document.addEventListener('DOMContentLoaded', function() {
        // Handle delete button clicks for drivers
