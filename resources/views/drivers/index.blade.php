                        ...
                        <table id="drivers-table" class="min-w-full divide-y divide-gray-200">
                            <thead class="bg-gray-50">
                                <tr>
                                    ...
                                    <th scope="col" class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Availability Status</th>
                            ...
                            <tbody class="bg-white divide-y divide-gray-200">
                                ...
                                <tr>
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        ...
                                        @if($driver->prefix)
                                            <div class="text-sm text-gray-500">{{ $driver->prefix }}</div>
                                        @endif
                                    </td>
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        <div class="text-sm text-gray-900">{{ $driver->position_name }}</div>
                                        @if($driver->office)
                                            <div class="text-sm text-gray-500">{{ $driver->office->office_name }}</div>
                                        @endif
                                        @if($driver->division)
                                            <div class="text-sm text-gray-500">{{ $driver->division->division_name }}</div>
                                        @endif
                                    </td>
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        <span class="px-2 inline-flex text-xs leading-5 font-semibold rounded-full 
                                            ...
                                            @elseif($driver->availability_status == 'Not Available')
                                                bg-red-100 text-red-800
                                            @elseif($driver->availability_status == 'On Duty')
                                                bg-blue-100 text-blue-800
                                            @elseif($driver->availability_status == 'Off Duty')
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                        ...
                                        <a href="{{ route('drivers.edit', $driver) }}" class="text-green-600 hover:text-green-900 mr-3">Edit</a>
